...
const Results: React.FC = () => {
  ...
  const galleryImages = [
    { src: 'https://images.pexels.com/photos/6873123/pexels-photo-6873123.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=2', category: 'Exterior', caption: 'Full exterior detail with ceramic coating' },
    { src: 'https://images.pexels.com/photos/6873100/pexels-photo-6873100.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=2', category: 'Interior', caption: 'Complete interior cleaning and conditioning' },
    { src: 'https://images.pexels.com/photos/6873122/pexels-photo-6873122.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=2', category: 'Paint Correction', caption: 'Professional paint correction and polishing' },
    { src: 'https://images.pexels.com/photos/6873008/pexels-photo-6873008.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=2', category: 'Ceramic', caption: 'Ceramic coating application' },
    { src: 'https://images.pexels.com/photos/6873015/pexels-photo-6873015.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=2', category: 'Interior', caption: 'Dashboard and console detailing' },
    { src: 'https://images.pexels.com/photos/6872176/pexels-photo-6872176.jpeg?auto=compress&cs=tinysrgb&w=600&h=400&dpr=2', category: 'Exterior', caption: 'Premium exterior wash and wax' }
  ];
  ...
  const testimonials = [
    { name: 'Jennifer Martinez', rating: 5, text: 'Absolutely amazing results! My 5-year-old SUV looks better than the day I bought it. The ceramic coating is incredible.', image: 'https://images.pexels.com/photos/1130626/pexels-photo-1130626.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&dpr=2' },
    { name: 'David Thompson', rating: 5, text: 'Professional service from start to finish. They came to my workplace and did an outstanding job on my truck.', image: 'https://images.pexels.com/photos/1222271/pexels-photo-1222271.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&dpr=2' },
    { name: 'Lisa Wang', rating: 5, text: 'The convenience and quality are unmatched. My car interior looks and smells like new. Highly recommend!', image: 'https://images.pexels.com/photos/774909/pexels-photo-774909.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&dpr=2' },
    { name: 'Robert Johnson', rating: 5, text: "Best investment I've made for my vehicle. The paint correction removed years of damage. Outstanding work!", image: 'https://images.pexels.com/photos/1239291/pexels-photo-1239291.jpeg?auto=compress&cs=tinysrgb&w=100&h=100&dpr=2' }
  ];
  ...
  const GalleryCardSkeleton = () => (
    <div className="rounded-lg overflow-hidden">
      <BoxShimmer className="h-64 w-full rounded-lg" />
    </div>
  );
  ...
  const TestimonialSkeleton = ({ delay = 0 }: { delay?: number }) => (
    <motion.div
      ...
      className="rounded-2xl border border-white/10 p-6 bg-zinc-900"
    >
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="pt-20 bg-black text-white">
      ...
      {/* Before/After */}
      <section ref={baRef} className="py-16 bg-zinc-950">
        <div className="max-w-7xl mx-auto px-4">
